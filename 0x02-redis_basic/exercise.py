...
def replay(method: Callable):
    """
    the replay to display hstory of calls
    """
...
class Cache:
    ...
    def __init__(self):
        """
        the constructor for redis model
        """
    ...
    def store(self, data: UnionOfTypes) -> str:
        """
        the store data into redis cache
        """
        key = str(uuid4())
